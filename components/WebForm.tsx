...
export default function WordForm() {
  ...
  return (
    <div className="p-4 justify-center items-center mx-auto flex md:flex-row flex-col w-full gap-3 border border-gray-600 rounded-xl mt-6 ">
      <div className="bg-[--arkaPlan] p-4 rounded-sm w-[400px] h-[550px]">
      ...
      <div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 overflow-y-auto h-[560px] ">
          {words.map((word) => (
            <div
              key={word.id}
